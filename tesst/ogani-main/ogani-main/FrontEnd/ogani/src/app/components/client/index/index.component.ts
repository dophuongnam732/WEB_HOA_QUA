...
export class IndexComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.useDetail = localStorage.getItem("username")
  }
  ...
  //     width: '400px' // Điều chỉnh kích thước modal theo ý muốn
  //   });
  // }
  ...
  login():void{
    ...
    this.authService.login(username,password).subscribe({
      next: res =>{
        ...
        this.showError("Thôn tin tài khoản hoặc mật khẩu không chính xác !");
      }
    })
  }
