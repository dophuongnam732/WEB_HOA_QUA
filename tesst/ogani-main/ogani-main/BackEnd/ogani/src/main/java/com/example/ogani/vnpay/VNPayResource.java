...
public class VNPayResource {
    ...
    public void paymentCallback(@RequestParam Map<String, String> queryParams, HttpServletRequest request, HttpServletResponse response) throws IOException {
        String vnp_ResponseCode = queryParams.get("vnp_ResponseCode");
        String orderId = queryParams.get("orderId");
        if (orderId != null && !orderId.equals("")) {
            if ("00".equals(vnp_ResponseCode)) {
                Order order = orderRepository.findById(Long.valueOf(orderId)).orElseThrow(() -> new RuntimeException("Du lieu khong ton tai"));
                order.setStatus(2);
                orderRepository.save(order);
                response.sendRedirect("http://localhost:4200/my-order");
            } else {
...
//        }
    ...
    @GetMapping("pay")
    public String getPay(@PathParam("price") long price, @PathParam("orderId") Integer orderId) throws UnsupportedEncodingException {
