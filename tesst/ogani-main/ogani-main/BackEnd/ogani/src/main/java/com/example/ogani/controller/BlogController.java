...
public class BlogController {
    ...
    @GetMapping("/BlockByTagId/{id}")
    @Operation(summary = "Lấy block theo ID tag")
    public ResponseEntity<List<Blog>> getBlockTagById(@PathVariable("id") Long id) {
        List<Blog> blogs = blogService.findBlogsByTagId(id);
        if (!blogs.isEmpty()) {
